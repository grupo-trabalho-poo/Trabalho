 ...
 */
public class LançamentoNota extends javax.swing.JFrame {

    /**
     * Creates new form LançamentoNota
     */
    public LançamentoNota() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jTextField4.setToolTipText("Digite a nota");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        // TODO add your handling code here:
        String nota = jTextField4.getText();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LançamentoNota.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new LançamentoNota().setVisible(true);
            }
        });
    }
